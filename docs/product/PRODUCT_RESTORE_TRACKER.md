...
| └ NOTIFICATION-INBOX-01 | Adressierte Inbox, echte Deep Links, Read-Semantik, Glocken-Badge → Spec `screens/notification_inbox.md`. **Emitter sind blockiert** — die Fläche bleibt ohne `NOTIFICATION-EMITTER-01` leer | REBUILD | spec_approved (2026-08-28, inkrementweise) | implemented (2026-09-03, `feature/notification-inbox-01`; Readiness `notifications` → ready reitet mit) | blocked(NOTIFICATION-EMITTER-01, PERMISSION-CATALOG-02) |
