...
| VALUATION-REHOST-01 | Sicherer interner Analyse-Rehost: Queue öffnen, Create auf Cloud-Property-Contract, Case Factors/Varianten/technische Einzelrechnungen/aggregate DCF; keine gemischte Opinion oder Ergebnisfreigabe. Specs: [Workflow](screens/valuation_v2_workflow.md), [Queue](screens/valuation_queue_v2.md), [Create](screens/valuation_create_v2.md), [Case](screens/valuation_case_workspace_v2.md) | MERGE | spec_approved (2026-09-01; `REHOST NOW`) | todo | todo |
...
| SCENARIO-VALUATION-01 (Inputs/Analysis/Scenarios/Versions/Offer) | Scenario-Lifecycle-Contract (Welle-5-Modell), VALUATION-REHOST-01; Zielbild/Gaps in [Valuation V2 Workflow](screens/valuation_v2_workflow.md) | blocked(contract; 2026-08-28 spezifiziert) | — | — |
| VALUATION-METHOD-CONTRACT-01 | `METHOD-GOV-01` technisch umsetzen: Value Basis, Ergebnisfamilien, Eligibility, getrennte Reconciliation und Approval Classes | METHOD-GOV-01 | blocked(backend/engine) | — | — |
