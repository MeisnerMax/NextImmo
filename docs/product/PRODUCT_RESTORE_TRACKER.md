...
| VALUATION-REHOST-01 | Sicherer interner Analyse-Rehost; Parent für 01A–01C. Specs: [Workflow](screens/valuation_v2_workflow.md), [Queue](screens/valuation_queue_v2.md), [Create](screens/valuation_create_v2.md), [Case](screens/valuation_case_workspace_v2.md) | MERGE | spec_approved (2026-09-01; `REHOST NOW`) | todo | todo |
