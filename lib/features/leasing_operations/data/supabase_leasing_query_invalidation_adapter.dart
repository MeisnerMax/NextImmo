...
/// One channel carrying all five published leasing tables.
///
/// Bindings differ per table because the write shapes do:
///
///   * `units`, `leases`, `leasing_cases`, `operations_signal_states` —
///     INSERT and UPDATE. Creation and every transition/update are both state
///     changes a list must see; an acknowledgement is created once (INSERT)
///     and then transitions (UPDATE), same shape as the other three.
...
class SupabaseLeasingRealtimeGateway implements LeasingRealtimeSupabaseGateway {
  ...
  static const Map<LeasingAggregate, String> _tables =
      <LeasingAggregate, String>{
        ...
        LeasingAggregate.operationsSignalState: 'operations_signal_states',
      };
