          ...
          NxKpiRow(
            children: [
              ...
              NxKpiTile(
                ...
                caption: 'Verhältnis Restschuld zu Objektwert',
                status: ltvTextColor,
                trailing: NxStatusBadge(
                  label: ltv < 60 ? 'Solide' : (ltv <= 75 ? 'Beobachten' : 'Kritisch'),
                  kind: ltv < 60
                      ? NxBadgeKind.success
                      : (ltv <= 75 ? NxBadgeKind.warning : NxBadgeKind.error),
                ),
              ),
            ],
          ),
      ...
      child: Column(
        ...
        children: [
          ...
          if (incomeByAccount.isEmpty && expenseByAccount.isEmpty)
            NxEmptyState(
              title: 'Keine Ledger-Einträge für $currentYear',
              description: 'Erfassen Sie Einnahmen und Ausgaben im Ledger-Modul, um die Gewinnanalyse zu sehen.',
  ...
  Widget _gewinnKpiCard({
    ...
    return ConstrainedBox(
      ...
      child: NxKpiTile(
        ...
        caption: subtitle,
        status: valueColor,
        trailing: Icon(icon, size: 18, color: valueColor),
      ),
    );
  }
                          ...
                          leftTitles: AxisTitles(
                            sideTitles: SideTitles(
                              ...
                              getTitlesWidget: (val, meta) => Text(
                                ...
                                style: Theme.of(context).textTheme.labelSmall?.merge(context.dataMonoStyle),
                              ),
                            ),
                          ),
                          ...
                          bottomTitles: AxisTitles(
                            sideTitles: SideTitles(
                              ...
                              getTitlesWidget: (val, meta) {
                                switch (val.toInt()) {
                                  case 0:
                                    return Text('Plan', style: Theme.of(context).textTheme.labelSmall?.copyWith(fontWeight: FontWeight.bold));
                                  case 1:
                                    return Text('Ist', style: Theme.of(context).textTheme.labelSmall?.copyWith(fontWeight: FontWeight.bold));
                                  case 2:
                                    return Text('Forecast', style: Theme.of(context).textTheme.labelSmall?.copyWith(fontWeight: FontWeight.bold));
                                  default:
                                    return const Text('');
                                }
                              },
