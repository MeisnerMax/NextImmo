...
/// Shell characterization for the canonical (single) `AppScaffold`.
///
/// Origin: W0-Shell-Cleanup (MOD-CLEAN-001). Written as a legacy-vs-V2 parity
/// test before the legacy `Sidebar`/`TopBar` path and the `UiScreenFlag`
/// branching were removed; kept as the permanent smoke test that the shell
/// renders its navigation and opens the properties page.
void main() {
  ...
  testWidgets('shell renders sidebar navigation and opens the properties page', (
    tester,
  ) async {
